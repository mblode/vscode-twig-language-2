...
if (manifest.name !== 'pretty-formatter') shared.push('src/extension.js', 'src/html.js', 'src/emmet.js', 'src/completions.js', 'src/templates.js', 'src/syntaxes/twig.tmLanguage', 'src/languages/twig.configuration.json', 'src/snippets/snippets.json');
const hashes = {};
